...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("ssid", type=str, help="WiFi SSID to connect to.", nargs='?', default="Robogarage_Wifi")
    parser.add_argument("password", type=str, help="Password of WiFi SSID.", nargs='?', default="metropolia1")
    parser.add_argument("url", type=str, help="RTMP server URL to stream to.", nargs='?', default="rtmp://192.168.0.50:1935/live/mystream")
...
#parser.add_argument("url", type=str, help="RTMP server URL to stream to.", nargs='?', default="rtmp://a.rtmp.youtube.com/live2/z7qg-2jqa-gtsq-p7uf-b4mv")